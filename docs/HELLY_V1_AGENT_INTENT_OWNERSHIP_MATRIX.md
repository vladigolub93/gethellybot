...
| `SUMMARY_REVIEW` | `backend-heavy` | `agent-first` | regex help patterns, deterministic approve/edit aliases, fallback non-empty text -> `request_summary_change`, service-side raw text command parsing | [candidate.py](/Users/vladigolub/Desktop/gethellybot/src/graph/stages/candidate.py), [candidate_profile/service.py](/Users/vladigolub/Desktop/gethellybot/src/candidate_profile/service.py) |
| `QUESTIONS_PENDING` | `mixed` | `agent-first` | regex help patterns, stage node delegates parsing to backend LLM helper only after candidate_input fallback, transport/service still assume text answer path | [candidate.py](/Users/vladigolub/Desktop/gethellybot/src/graph/stages/candidate.py), [candidate_profile/service.py](/Users/vladigolub/Desktop/gethellybot/src/candidate_profile/service.py) |
...
| `VACANCY_SUMMARY_REVIEW` | `backend-heavy` | `agent-first` | regex help patterns, deterministic approve/edit aliases, fallback non-empty text -> `request_summary_change`, service-side raw text command parsing | [manager.py](/Users/vladigolub/Desktop/gethellybot/src/graph/stages/manager.py), [vacancy/service.py](/Users/vladigolub/Desktop/gethellybot/src/vacancy/service.py) |
...
| `INTERVIEW_INVITED` | `mixed` | `agent-first` | regex help patterns, deterministic accept/skip aliases in stage node and service fallback | [candidate.py](/Users/vladigolub/Desktop/gethellybot/src/graph/stages/candidate.py), [interview/service.py](/Users/vladigolub/Desktop/gethellybot/src/interview/service.py) |
| `INTERVIEW_IN_PROGRESS` | `mixed` | `agent-first` | regex clarification patterns, default text -> `answer_current_question`, service-side media branching | [candidate.py](/Users/vladigolub/Desktop/gethellybot/src/graph/stages/candidate.py), [interview/service.py](/Users/vladigolub/Desktop/gethellybot/src/interview/service.py) |
