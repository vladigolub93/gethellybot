...
- implemented:
  ...
  - graph-owned execution for `VACANCY_SUMMARY_REVIEW`
  - graph-driven validation and backend handoff for `approve_summary`
  - graph-driven validation and backend handoff for `request_summary_change`
...
- implemented:
  ...
  - `scripts/watch_telegram_user.py`
