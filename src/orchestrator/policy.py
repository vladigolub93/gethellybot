...
STATE_POLICY_DEFINITIONS: dict[str, StatePolicyDefinition] = {
    ...
    "VACANCY_REVIEW": StatePolicyDefinition(
        ...
        guidance_text="Review the current vacancy card and use Apply or Skip under that role. If the manager already approved it, the primary button will switch to Connect. New roles stay queued until you decide on the current card. You can also ask about the current role here, or update your matching preferences if the role keeps missing.",
        help_text=(
            ...
            "Helly will not send the next role until you decide on the current one. "
    ...
    "PRE_INTERVIEW_REVIEW": StatePolicyDefinition(
        ...
        guidance_text="Review the current candidate card and use Connect or Skip under that profile. New candidates stay queued until you decide on the current card. You can also ask about the current candidate here, or update the vacancy if the candidate flow keeps missing.",
        help_text=(
            ...
            "Helly will not send the next candidate until you decide on the current one. "
