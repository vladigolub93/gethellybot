...
class CandidateReadyDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    keep_current_state: bool = True
...
class CandidateVacancyReviewDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
...
class CandidateVerificationDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    keep_current_state: bool = True
...
class ContactRequiredDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    keep_current_state: bool = True
...
class RoleSelectionDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    keep_current_state: bool = True
...
class VacancyIntakeDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
...
class VacancyClarificationDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    answer_text: Optional[str] = None
...
class ManagerReviewDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    keep_current_state: bool = True
...
class PreInterviewReviewDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
...
class InterviewInProgressDecisionSchema(BaseModel):
    intent: str
    response_text: Optional[str] = None
    proposed_action: Optional[str] = None
    answer_text: Optional[str] = None
