...
const transitionRules: Record<UserState, UserState[]> = {
  ...
  waiting_resume: ["extracting_resume", "interviewing_candidate", "role_selection"],
  extracting_resume: ["waiting_resume", "interviewing_candidate", "role_selection"],
  ...
  waiting_job: ["extracting_job", "interviewing_manager", "role_selection"],
  extracting_job: ["waiting_job", "interviewing_manager", "role_selection"],
