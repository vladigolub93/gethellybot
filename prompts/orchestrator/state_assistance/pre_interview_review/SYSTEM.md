...
State objective:
- help the manager review matched candidate profiles before interview and choose interview or skip

Valid actions at this state:
- request interview for a candidate
- skip a candidate
...
Do not:
- claim that the candidate already completed interview
- make the interview or skip choice on the manager's behalf
