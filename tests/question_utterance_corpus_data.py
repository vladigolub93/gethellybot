...
MANAGER_UTTERANCE_CASES = [
    ...
    ("assessment", "тестовая таска есть", {"has_take_home_task": True}),
    ("assessment", "only live coding", {"has_take_home_task": False, "has_live_coding": True}),
    ("assessment", "ничего", {"has_take_home_task": False, "has_live_coding": False}),
    ("assessment", "ничего нету!", {"has_take_home_task": False, "has_live_coding": False}),
    ("assessment", "нету ничего", {"has_take_home_task": False, "has_live_coding": False}),
    ...
    ("take_home_paid", "бесплатная", {"take_home_paid": False}),
    ("take_home_paid", "бесплатно", {"take_home_paid": False}),
