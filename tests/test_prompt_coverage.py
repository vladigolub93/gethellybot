...
def test_core_prompt_families_exist() -> None:
    required_prompt_paths = [
        ...
        ("entry", "role_selection_decision"),
        ("candidate", "cv_extract"),
        ("candidate", "cv_pending_decision"),
        ("candidate", "cv_processing_decision"),
        ("candidate", "ready_decision"),
        ("candidate", "verification_decision"),
        ...
        ("vacancy", "jd_processing_decision"),
        ("vacancy", "open_decision"),
        ("vacancy", "summary_review_decision"),
        ("vacancy", "summary_merge"),
        ("vacancy", "clarification_decision"),
